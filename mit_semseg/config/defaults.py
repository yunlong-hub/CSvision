...
_C = CN()
_C.DIR = "ckpt/ADE/ade20k-resnet50dilated-ppm_deepsup"

# -----------------------------------------------------------------------------
# Dataset
# -----------------------------------------------------------------------------
_C.DATASET = CN()
_C.DATASET.dataset = "ADE20K"
_C.DATASET.root_dataset = "./Data/ADE20K"
_C.DATASET.list_train = "./Data/ADE20K/training.odgt"
_C.DATASET.list_val = "./Data/ADE20K/validation.odgt"
